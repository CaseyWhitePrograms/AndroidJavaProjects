    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        fab.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                arguments.putStringArray(TechniqueDetailFragment.ARG_ITEM_ID,
                        getIntent().getStringArrayExtra(TechniqueDetailFragment.ARG_ITEM_ID));
                ...
                TechniqueDetailActivity activity = (TechniqueDetailActivity)view.getContext();
        ...
        if (savedInstanceState == null)
        {
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.technique_detail_container, fragment)
                    .commit();
        }
    }
