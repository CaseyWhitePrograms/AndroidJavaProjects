...
//        ma.onDisplayDate(calendar);
        ...
        edListener.onDisplayEndDate(calendar);
    }
    ...
    public interface EndDateListener
    {
        ...
        public void onDisplayEndDate(Calendar aDate);
    }

    // Use this instance of the interface to deliver action events to main activity
    private  EndDateListener edListener;
...
//    public void onAttach(Activity activity) // is deprecated
    public void onAttach(Context context)
    {
        ...
        try
        {
            // Instantiate the EndDateListener so we can send events to the host
            edListener = (EndDateListener) context;
        }
        catch (ClassCastException e)
        {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(context.toString()
                    + " must implement EndDateListener");
        }
    }
}
